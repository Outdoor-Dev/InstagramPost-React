		...
		<>
			...
			<div className="background-image" style={{ height: 1000 }}>
				<div
					...
					<div class Name="scrollable-post">
						<div className="post">
							...
							<div className="card-body ">
								...
								<p className="card-text text-left ">
									...
									The Pacific sea nettle is carnivorous and
									eats simple and easy-to-catch animals:
									zooplankton, larval fishes, crustaceans,
									eggs, and sometimes other jellies. But
									without a mouth, how do these jellies eat?
									Not by filtration like you might expect, but
									more actively through a process that’s a
									little like that of a venus flytrap. With a
									single ...{" "}
